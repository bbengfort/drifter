# drifter.conf
# A simple configuration module for Drifter
#
...
"""
Drifter class for specifying Drifter specific optional items via a YAML
...
class Configuration(object):
    ...
    CONF_PATHS = [
        '/etc/drifter.yaml',                    # The global configuration
        os.path.expanduser('~/.drifter.yaml'),  # User specific configuration
        os.path.abspath('conf/drifter.yaml')    # Local directory configuration
    ]
...
##########################################################################
## Drifter Configuration Defaults
##########################################################################

class DrifterConfiguration(Configuration):
    """
    This object contains the default configuration of Drifter.
...
settings = DrifterConfiguration.load()
